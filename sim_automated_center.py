...
class AutomatedMultiview():
    def __init__(self):   
        ...
        self.include_classes = ['chair', 'bed', 'toilet', 'sofa', 'indoor-plant', 'refrigerator', 'tv-screen']
    ...
    def run_episodes(self):
        ...
        for episode in range(self.num_episodes):
            ...
            self.basepath = f"/home/nel/gsarch/replica_orbslam/{mapname}_{episode}"
